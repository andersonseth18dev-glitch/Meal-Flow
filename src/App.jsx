...
export default function App() {
  ...
  const printMealPlan = () => {
    ...
    win.document.write(`<!DOCTYPE html><html><head><title>MealFlow — Weekly Meal Plan</title>
    <style>
      body { font-family: Arial, sans-serif; padding: 20px; color: #222; }
      h1 { color: #e8751a; margin-bottom: 4px; }
      .subtitle { color: #888; font-size: 13px; margin-bottom: 20px; }
      table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
      th { background: #e8751a; color: white; padding: 10px; font-size: 13px; text-align: left; }
      .summary { background: #fff8f3; border: 2px solid #e8751a; border-radius: 8px; padding: 14px 20px; display: flex; gap: 30px; margin-bottom: 16px; }
      .summary-item { text-align: center; }
      .summary-item .val { font-size: 22px; font-weight: 900; color: #e8751a; }
      .summary-item .lbl { font-size: 11px; color: #888; }
      @media print { body { padding: 10px; } }
    </style></head><body>
    <h1>🍴 MealFlow — Weekly Meal Plan</h1>
    ...
    <div style="font-size:11px;color:#aaa;text-align:center;margin-top:20px;">Generated by MealFlow — mealprephome.netlify.app</div>
  ...
  const printGroceryList = () => {
    ...
    const win = window.open("","_blank");
    win.document.write(`<!DOCTYPE html><html><head><title>MealFlow — Grocery List</title>
    <style>
      body { font-family: Arial, sans-serif; padding: 20px; color: #222; }
      h1 { color: #e8751a; margin-bottom: 4px; }
      .subtitle { color: #888; font-size: 13px; margin-bottom: 20px; }
      table { width: 100%; border-collapse: collapse; }
      .tip { background:#fff8f3; border-left:4px solid #e8751a; padding:10px 14px; margin-bottom:16px; font-size:13px; color:#555; border-radius:0 8px 8px 0; }
      @media print { body { padding: 10px; } }
    </style></head><body>
    <h1>🛒 MealFlow — Grocery List</h1>
